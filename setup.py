...
class PrepReadme(Command):
    ...
    def run_pandoc():
        ...
        try:
            sp.call(['pandoc', '--from=markdown', '--to=rst',
...
if cythonize is not None and numpy is not None:
    ext_modules = cythonize([
        ...
        Extension(
            ...
            extra_link_args=extra_link_args),
        Extension(
            "DDTWdistance.ddtw_c", ["DDTWdistance/ddtw_c.pyx"],
            include_dirs=np_include_dirs,
            extra_compile_args=extra_compile_args,
            extra_link_args=extra_link_args)])
elif numpy is None:
    ...
    ext_modules = []
    # ext_modules = [
    #     Extension("LCSSdistance.lcss_c", ["LCSSdistance/lcss_c.c"],
...
with open('LCSSdistance/__init__.py', 'r') as fd:
...
setup(
    ...
    #},
    packages=["LCSSDistance", "EDRDistance", "ERPDistance", "DDTWdistance"],
