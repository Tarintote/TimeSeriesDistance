# -*- coding: UTF-8 -*-
"""
dtaidistance.ddtw_weighted
~~~~~~~~~~~~~~~~~~~~~~~~~

Dynamic Time Warping (ddtw) with custom internal distance function.
...
The distance d, used in ddtw, is multiplied with factor w(d):
...
def warping_paths(s1, s2, weights=None, window=None, **_kwargs):
    ...
    :return: ddtw similarity m between s1 and s2, warping paths matrix
    """
    # TODO: copy original function in ddtw to support all options and integrate weights
    # print('warping_paths')
    l1 = len(s1)
    l2 = len(s2)
    # print('l1', l1, 'l2', l2)
...
def series_to_dt(series, labels, prototypeidx, classifier=None, max_clfs=None, min_ig=0,
    ...
    :param classifier: Classifier class.
        For example ddtw_weighted.DecisionTreeClassifier or tree.DecisionTreeClassifier
